...
bidConstant = {
	...
	contractAddress: '0x84403dc745199BD28140744869777D463DAC5f0a',
	abi: [
		{
			inputs: [
		...
		},
		{
			...
			inputs: [
				...
				{ indexed: false, internalType: 'uint256', name: '_bidPrice', type: 'uint256' },
		...
		},
		{
			...
			inputs: [
				{ indexed: false, internalType: 'address', name: 'user', type: 'address' },
				{ indexed: false, internalType: 'uint256', name: '_pid', type: 'uint256' },
				{ indexed: false, internalType: 'int256', name: '_combo', type: 'int256' },
				{ indexed: false, internalType: 'uint256', name: '_nftTokenId', type: 'uint256' },
			],
			name: '_open',
			type: 'event',
		},
		...
		{
			inputs: [ { internalType: 'string[]', name: '_items', type: 'string[]' } ],
			name: 'initNFTItems',
			outputs: [],
			stateMutability: 'nonpayable',
			type: 'function',
		...
		},
		{
			...
			outputs: [
				...
				{ internalType: 'address payable', name: 'latestUser', type: 'address' },
