...
let pbrMaticStakingConstant;
// Mainnet

pbrMaticStakingConstant = {
  rpcUrl: "https://bsc-dataseed.binance.org/",
  chainId: 1, //Mainet
  contractAddress: "0x6335aF028e77B574423733443678aD4cb9e15B3D",
  abi: [
    {
      inputs: [
...
let rpcUrl = `https://polygon-mainnet.infura.io/${providerKey}`;

var web3 = new Web3(rpcUrl);
var pbrMaticStakingContract = new web3.eth.Contract(
  pbrMaticStakingConstant.abi,
  pbrMaticStakingConstant.contractAddress
);

export default pbrMaticStakingContract;
