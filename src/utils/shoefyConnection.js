...
let shoefyStakeConstant;
// Mainnet

shoefyStakeConstant = {
  chainId: 1, //Mainet
  contractAddress: "0x1b46b72c5280f30Fbe8A958B4f3c348FD0fD2E55",
  abi: [
    {
      inputs: [
...
var shoefyStakeContract = new web3.eth.Contract(
  shoefyStakeConstant.abi,
  shoefyStakeConstant.contractAddress
);

export default shoefyStakeContract;
